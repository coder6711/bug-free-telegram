var bg,sleep, brush, gym, eat, bath, move, drink, gym2;
var astronaut;
...
function draw() {
  ...
  text("Space key = Sleeping",20,145);
  text("Enter key = Exercising",20,160)
  ...
  if(keyDown("ENTER")){
    astronaut.addAnimation("gym2ing", gym2);
    astronaut.changeAnimation("gym2ing");
    astronaut.x = 300;
    astronaut.y = 330;
    astronaut.velocityX = 0;
    astronaut.velocityY = 0;
